...
from dagster_app.assets import HNStoriesConfig, hackernews_top_story_ids, hackernews_top_stories
from unittest import mock


CONFIG = HNStoriesConfig(
    hn_top_story_ids_path="dagster_app_tests/hackernews_top_story_ids.json",
    hn_top_stories_path="dagster_app_tests/hackernews_top_stories.csv",
)
...
def test_hackernews_top_stories(mock_get):
    ...
    os.remove("dagster_app_tests/hackernews_top_stories.csv")
